...
parser.add_argument('--resume', '-r', default='sysu_agw_p4_n4_lr_0.1_seed_0_scg0.1_best.t', type=str, help='resume from checkpoint')
...
if dataset == 'sysu':
    ...
    for trial in range(10):
        ...
        # ===== 新增距离矩阵 =====
        # distmat7: fc原图 + fc灰度-灰度 平均
        distmat7 = (distmat + distmat3) / 2
        cmc7, mAP7, mINP7 = eval_sysu(-distmat7, query_label, gall_label, query_cam, gall_cam)

        # distmat8: pool原图距离
        distmat8 = np.matmul(query_feat_pool, np.transpose(gall_feat_pool))
        cmc8, mAP8, mINP8 = eval_sysu(-distmat8, query_label, gall_label, query_cam, gall_cam)

        # distmat9: pool原图 + fc原图 平均
        distmat9 = (distmat8 + distmat) / 2
        cmc9, mAP9, mINP9 = eval_sysu(-distmat9, query_label, gall_label, query_cam, gall_cam)

        # distmat10: pool灰度-灰度距离
        distmat10 = np.matmul(Xquery_feat_pool, np.transpose(Xgall_feat_pool))
        cmc10, mAP10, mINP10 = eval_sysu(-distmat10, query_label, gall_label, query_cam, gall_cam)

        # distmat11: pool灰度-灰度 + fc灰度-灰度 平均
        distmat11 = (distmat10 + distmat3) / 2
        cmc11, mAP11, mINP11 = eval_sysu(-distmat11, query_label, gall_label, query_cam, gall_cam)

        # distmat12: distmat11 + distmat9 平均 (终极融合)
        distmat12 = (distmat11 + distmat9) / 2
        cmc12, mAP12, mINP12 = eval_sysu(-distmat12, query_label, gall_label, query_cam, gall_cam)
        ...
        if trial == 0:
            ...
            all_cmc12 = all_cmc12 + cmc12
            all_mAP12 = all_mAP12 + mAP12
            all_mINP12 = all_mINP12 + mINP12

        print('Test Trial: {}'.format(trial))
        print('FC:   Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
                cmc[0], cmc[4], cmc[9], cmc[19], mAP, mINP))
        print('FC1:  Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
                cmc1[0], cmc1[4], cmc1[9], cmc1[19], mAP1, mINP1))
        print('FC2:  Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
                cmc2[0], cmc2[4], cmc2[9], cmc2[19], mAP2, mINP2))
        print('FC3:  Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
                cmc3[0], cmc3[4], cmc3[9], cmc3[19], mAP3, mINP3))
        print('FC4:  Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
                cmc4[0], cmc4[4], cmc4[9], cmc4[19], mAP4, mINP4))
        print('FC5:  Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
                cmc5[0], cmc5[4], cmc5[9], cmc5[19], mAP5, mINP5))
        print('FC6:  Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
                cmc6[0], cmc6[4], cmc6[9], cmc6[19], mAP6, mINP6))
        print('FC7:  Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
                cmc7[0], cmc7[4], cmc7[9], cmc7[19], mAP7, mINP7))
        print('POOL8:  Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
                cmc8[0], cmc8[4], cmc8[9], cmc8[19], mAP8, mINP8))
        print('POOL9:  Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
                cmc9[0], cmc9[4], cmc9[9], cmc9[19], mAP9, mINP9))
        print('POOL10: Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
                cmc10[0], cmc10[4], cmc10[9], cmc10[19], mAP10, mINP10))
        print('POOL11: Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
                cmc11[0], cmc11[4], cmc11[9], cmc11[19], mAP11, mINP11))
        print('ALL12:  Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
                cmc12[0], cmc12[4], cmc12[9], cmc12[19], mAP12, mINP12))
