...
class FocalLoss(nn.Module):
    """Soft Consistency Guidance (SCG) loss.
    Combines BCE loss and Dice loss to align FRL heatmaps with YOLO masks.
    ...
    def forward(self, mask, heatmaps):
        """
        Args:
            mask:     [B, 1, H, W] binary mask (0/1), ground truth from YOLO
            heatmaps: [B, 1, H, W] foreground heatmap (0~1), FRL output
        Returns:
            loss: scalar, BCE + Dice
        """
        # BCE Loss
