...
from utils import *
import pdb
SYSU_DATA_PATH = "../Datasets/SYSU-MM01/"
...
if dataset == 'sysu':
    ...
    if len(args.resume) > 0:
        ...
        # model_path = checkpoint_path + 'sysu_mcl_p4_n8_lr_0.1_seed_0_best.t'
    ...
    for trial in range(10):
        ...
        # combined (same as SFGPN: weighted sum)
        a = 0.3
        distmat_all = a * distmat_pool + (1 - a) * distmat_fc
        ...
        if trial == 0:
            ...
            all_cmc_all = all_cmc_all + cmc_all
            all_mAP_all = all_mAP_all + mAP_all
            all_mINP_all = all_mINP_all + mINP_all
...
cmc_all = all_cmc_all / 10
mAP_all = all_mAP_all / 10
mINP_all = all_mINP_all / 10
print('All Average:')
